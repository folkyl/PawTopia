...
<div class="content">
    ...
    <div class="filter-container">
        <select>
            ...
            <option>Cat Vitamins</option>
            <option>Dog Vitamins</option>
        </select>
        <select>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="action-btns">
                        <button class="btn-edit" onclick="openEditProductModal('Whiskas','Rp. 200.000','Cat Vitamins',10)">Edit</button>
                ...
                <tr>
                    ...
                    <td>Rp. 180.000</td>
                    <td class="action-btns">
                        <button class="btn-edit" onclick="openEditProductModal('Pedigree','Rp. 180.000','Dog Vitamins',10)">Edit</button>
                        <button class="btn-delete">Delete</button>
                    </td>
                </tr>
            </tbody>
