    ...
    <main class="dashboard-main">
        ...
        <div class="stats-summary">
            <div class="summary-card">
                <div class="summary-icon total">
                    <img src="http://127.0.0.1:8000/image/admin/kalender.svg" alt="Total Bookings Icon" class="icon-image">
                </div>
                <div class="summary-content">
                    <div class="summary-number" id="totalBookings">20</div>
                    <div class="summary-label">Total Bookings</div>
                </div>
            </div>
            <div class="summary-card">
                <div class="summary-icon active">
                    <img src="http://127.0.0.1:8000/image/admin/boxx.svg" alt="Active Pets Icon" class="icon-image">
                </div>
                <div class="summary-content">
                    <div class="summary-number" id="activePets">8</div>
                    <div class="summary-label">Pets Currently Boarded</div>
                </div>
            </div>
            <div class="summary-card">
                <div class="summary-icon pending">
                    <img src="http://127.0.0.1:8000/image/admin/hourglass.svg" alt="Pending Icon" class="icon-image">
                </div>
                <div class="summary-content">
                    <div class="summary-number" id="pendingBookings">6</div>
                    <div class="summary-label">Awaiting Confirmation</div>
                </div>
            </div>
            <div class="summary-card">
                <div class="summary-icon revenue">
                    <img src="http://127.0.0.1:8000/image/admin/koin.svg" alt="Revenue Icon" class="icon-image">
                </div>
                <div class="summary-content">
                    <div class="summary-number" id="monthlyRevenue">Rp 11.8M</div>
        ...
        <div class="content-card">
            ...
            <div id="searchStatus" class="search-status">
                <!-- Search status will be generated by JavaScript -->
            </div>
        </div>
    </main>
</div>
...
/* Pagination style: match feedback look for existing page-link markup */
.pagination-btn,
.page-link {
    background: linear-gradient(135deg, #FFE0B2, #FFCC99);
    color: #6B4F3A;
...
document.addEventListener('DOMContentLoaded', function() {
    // Sample booking data
    const bookings = [
        { id: 1, customer: 'Sarah Johnson', pet: 'Bella', petType: 'Dog', checkin: '2025-08-20', checkout: '2025-08-25', duration: '5 days', status: 'confirmed', phone: '081234567890', email: 'sarah@email.com', service: 'Pet Pickup', price: 750000 },
        { id: 2, customer: 'Michael Chen', pet: 'Whiskers', petType: 'Cat', checkin: '2025-08-22', checkout: '2025-08-24', duration: '2 days', status: 'OnPickup', phone: '081234567891', email: 'michael@email.com', service: 'Drop Off', price: 400000 },
        { id: 3, customer: 'Amanda Putri', pet: 'Rocky', petType: 'Dog', checkin: '2025-08-18', checkout: '2025-08-20', duration: '2 days', status: 'checked-in', phone: '081234567892', email: 'amanda@email.com', service: 'Drop Off', price: 600000 },
        { id: 4, customer: 'Robert Williams', pet: 'Luna', petType: 'Cat', checkin: '2025-08-15', checkout: '2025-08-18', duration: '3 days', status: 'completed', phone: '081234567893', email: 'robert@email.com', service: 'Pet Pickup', price: 450000 },
        { id: 5, customer: 'Lisa Maharani', pet: 'Max', petType: 'Dog', checkin: '2025-08-25', checkout: '2025-08-30', duration: '5 days', status: 'confirmed', phone: '081234567894', email: 'lisa@email.com', service: 'Drop Off', price: 1000000 },
        { id: 6, customer: 'David Kumar', pet: 'Milo', petType: 'Cat', checkin: '2025-08-28', checkout: '2025-08-30', duration: '2 days', status: 'On Pickup', phone: '081234567895', email: 'david@email.com', service: 'Pet Pickup', price: 300000 },
        { id: 7, customer: 'Jessica Wong', pet: 'Bruno', petType: 'Dog', checkin: '2025-08-12', checkout: '2025-08-15', duration: '3 days', status: 'On Pickup', phone: '081234567896', email: 'jessica@email.com', service: 'Pet Pickup', price: 900000 },
        { id: 8, customer: 'Andrew Lee', pet: 'Coco', petType: 'Cat', checkin: '2025-08-30', checkout: '2025-09-02', duration: '3 days', status: 'confirmed', phone: '081234567897', email: 'andrew@email.com', service: 'Drop Off', price: 600000 },
        { id: 9, customer: 'Rachel Green', pet: 'Charlie', petType: 'Dog', checkin: '2025-08-16', checkout: '2025-08-18', duration: '2 days', status: 'cancelled', phone: '081234567898', email: 'rachel@email.com', service: 'Pet Pickup', price: 400000 },
        { id: 10, customer: 'Kevin Tan', pet: 'Smokey', petType: 'Cat', checkin: '2025-08-26', checkout: '2025-08-28', duration: '2 days', status: 'pending', phone: '081234567899', email: 'kevin@email.com', service: 'Pet Pickup', price: 300000 },
        { id: 11, customer: 'Maria Santos', pet: 'Buddy', petType: 'Dog', checkin: '2025-08-21', checkout: '2025-08-24', duration: '3 days', status: 'confirmed', phone: '081234567800', email: 'maria@email.com', service: 'Pet Pickup', price: 750000 },
        { id: 12, customer: 'James Miller', pet: 'Shadow', petType: 'Cat', checkin: '2025-08-23', checkout: '2025-08-25', duration: '2 days', status: 'pending', phone: '081234567801', email: 'james@email.com', service: 'Pet Pickup', price: 600000 },
        { id: 13, customer: 'Sophie Brown', pet: 'Rex', petType: 'Dog', checkin: '2025-08-19', checkout: '2025-08-22', duration: '3 days', status: 'checked-in', phone: '081234567802', email: 'sophie@email.com', service: 'Pet Pickup', price: 600000 },
        { id: 14, customer: 'Daniel Park', pet: 'Fluffy', petType: 'Cat', checkin: '2025-08-17', checkout: '2025-08-19', duration: '2 days', status: 'Checked-In', phone: '081234567803', email: 'daniel@email.com', service: 'Pet Pickup', price: 400000 },
        { id: 15, customer: 'Emily Davis', pet: 'Zeus', petType: 'Dog', checkin: '2025-08-29', checkout: '2025-09-01', duration: '3 days', status: 'confirmed', phone: '081234567804', email: 'emily@email.com', service: 'Pet Pickup', price: 900000 },
        { id: 16, customer: 'Thomas Wilson', pet: 'Mittens', petType: 'Cat', checkin: '2025-08-24', checkout: '2025-08-26', duration: '2 days', status: 'pending', phone: '081234567805', email: 'thomas@email.com', service: 'Pet Pickup', price: 300000 },
        { id: 17, customer: 'Hannah Kim', pet: 'Oscar', petType: 'Dog', checkin: '2025-08-13', checkout: '2025-08-16', duration: '3 days', status: 'completed', phone: '081234567806', email: 'hannah@email.com', service: 'Pet Pickup', price: 750000 },
        { id: 18, customer: 'Christopher Lee', pet: 'Princess', petType: 'Cat', checkin: '2025-08-27', checkout: '2025-08-29', duration: '2 days', status: 'confirmed', phone: '081234567807', email: 'christopher@email.com', service: 'Pet Pickup', price: 300000 },
        { id: 19, customer: 'Olivia Martinez', pet: 'Diesel', petType: 'Dog', checkin: '2025-08-31', checkout: '2025-09-03', duration: '3 days', status: 'pending', phone: '081234567808', email: 'olivia@email.com', service: 'Drop Off', price: 900000 },
        { id: 20, customer: 'Ryan Thompson', pet: 'Snowball', petType: 'Cat', checkin: '2025-08-14', checkout: '2025-08-17', duration: '3 days', status: 'completed', phone: '081234567809', email: 'ryan@email.com', service: 'Pet Pickup', price: 600000 }
    ...
    function renderPageInfo() {
        ...
        if (filteredBookings.length === 0) {
            ...
            pageInfo.innerHTML = `Showing ${startIndex}-${endIndex} of ${filteredBookings.length} bookings (Page ${currentPage} of ${totalPages})`;
        }
    }
    ...
    function renderSearchStatus() {
        ...
        if (searchTerm || selectedStatus) {
            ...
            searchStatus.innerHTML = 'Showing all bookings';
            searchStatus.style.display = 'inline-block';
        }
    }
