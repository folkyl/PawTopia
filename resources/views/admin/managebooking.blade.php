        ...
        <div class="content-card">
            ...
            <div class="pagination-wrapper">
                <div class="pagination">
                    <button class="page-btn prev" onclick="changePage(currentPage - 1)" :disabled="currentPage <= 1">&lt;</button>
                    <template x-for="page in totalPages" :key="page">
                        <button 
                            class="page-btn" 
                            :class="{ 'active': page === currentPage }"
                            @click="currentPage = page; renderBookings()"
                            x-text="page"
                        ></button>
                    </template>
                    <button class="page-btn next" onclick="changePage(currentPage + 1)" :disabled="currentPage >= totalPages">&gt;</button>
                </div>
            </div>
...
.page-link:hover {
    background: #FFF3E0;
    transform: translateY(-2px);
    box-shadow: 0 4px 12px rgba(229, 115, 0, 0.15);
}
...
.page-item.active .page-link {
    ...
    color: #fff;
    border-color: #E57300;
    box-shadow: 0 4px 12px rgba(229, 115, 0, 0.25);
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderBookings() {
        ...
        if (pagination) {
            let paginationHTML = `
                <button class="page-btn prev" onclick="changePage(${currentPage - 1})" ${currentPage <= 1 ? 'disabled' : ''}>&lt;</button>
            `;
            ...
            paginationHTML += `
                <button class="page-btn next" onclick="changePage(${currentPage + 1})" ${currentPage >= totalPages ? 'disabled' : ''}>&gt;</button>
            `;
